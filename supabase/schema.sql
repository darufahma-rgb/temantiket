...
-- ============================================================================
-- Fase 19: ticket_prices
-- AI Ticket Price List & Smart Margin Manager
-- ============================================================================
...
create policy "ticket_prices_insert" on public.ticket_prices
  for insert with check (public.is_member(agency_id) and not public.is_agent(agency_id));
...
create policy "ticket_prices_update" on public.ticket_prices
  for update using (public.is_member(agency_id) and not public.is_agent(agency_id))
  with check (public.is_member(agency_id) and not public.is_agent(agency_id));
