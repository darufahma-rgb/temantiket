  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "linear-gradient(135deg, #0866FF 0%, #0654D6 100%)" }}
      >
        {isBroadcast ? (
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-3 bg-gray-50/50">
              ...
              {loading && (
                <div className="flex items-start gap-1.5">
                  <div className="w-5 h-5 rounded-full overflow-hidden flex items-center justify-center shrink-0 mt-0.5" style={{ background: "linear-gradient(135deg, #0866FF, #0654D6)" }}>
                    <img src="/chatgpt-icon.png" alt="AITEM" className="w-3.5 h-3.5 object-contain" />
                  </div>
                  <div className="bg-white border border-border/60 rounded-2xl rounded-bl-sm px-3 py-2.5 shadow-sm">
                    <div className="flex items-center gap-2 text-xs text-muted-foreground">
                      <Loader2 className="w-3.5 h-3.5 animate-spin" style={{ color: "#0866FF" }} />
