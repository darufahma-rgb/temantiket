    ...
    <div className="live-clock-card relative overflow-hidden rounded-2xl border backdrop-blur-sm shadow-sm">
      ...
      <div className="relative px-3 py-2.5 md:px-4 md:py-3">
        <div className="flex items-center gap-1.5 mb-1.5">
          ...
          <span className="live-clock-title text-[10.5px] md:text-[11px] font-bold uppercase tracking-wider">
            Waktu Dunia
          </span>
        ...
        >
          {ZONES.map((z) => (
            <div
              key={z.timeZone}
              className="live-clock-tile rounded-xl border px-2 py-1.5 md:px-2.5 md:py-2 min-w-[96px] flex-shrink-0"
            >
              <div className="flex items-center gap-1">
                <span className="text-[11px] leading-none">{z.flag}</span>
                <span className="live-clock-short text-[9.5px] md:text-[10px] font-bold uppercase tracking-wider">
                  {z.short}
                </span>
              </div>
              <div className="live-clock-time font-mono font-extrabold text-[15px] md:text-[16px] leading-tight tabular-nums mt-0.5">
                {formatTime(now, z.timeZone)}
              </div>
              <div className="live-clock-day text-[9.5px] md:text-[10px] leading-tight truncate">
