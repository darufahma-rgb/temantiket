  ...
  return (
    <div className="space-y-3">
      ...
      <div className="rounded-xl border border-slate-200 bg-white overflow-hidden">
        <div className="flex items-center gap-2 px-3 py-2 border-b border-slate-200 bg-gradient-to-r from-sky-500 to-sky-600 text-white">
              ...
              {tiers.map((tier, i) => (
                <tr key={`${tier.min}-${tier.max}`} className={i % 2 === 0 ? "bg-white" : "bg-slate-50/50"}>
                  ...
                  {activeRooms.map((r) => {
                    ...
                    return (
                      <td key={r} className="px-3 py-2 text-right font-mono font-semibold text-sky-600 border-b border-slate-100">
