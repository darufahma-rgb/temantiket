...
// Deterministic sparkle positions — defined outside component so they don't
...
export default function Login() {
  ...
  // Auto-focus
  useEffect(() => {
    if (phase === "form") setTimeout(() => emailRef.current?.focus(), 80);
    if (phase === "pin")  setTimeout(() => pinRef.current?.focus(), 80);
  }, [phase]);
