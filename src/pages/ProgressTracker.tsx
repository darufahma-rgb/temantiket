...
// ── Jamaah step config ────────────────────────────────────────────────────────
const JAMAAH_STEPS = [
  { key: "registered", label: "Terdaftar",      icon: UserCheck,  color: "#0866FF" },
  { key: "docs",       label: "Dokumen",         icon: FileKey,    color: "#8b5cf6" },
  { key: "paid",       label: "Pembayaran",      icon: CreditCard, color: "#0866FF" },
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="w-full h-1.5 bg-gray-100 rounded-full overflow-hidden">
          <div
            ...
            style={{ width: `${pct}%`, background: `linear-gradient(90deg, #0866FF, ${stepColor})` }}
          />
        </div>
    ...
    <div className="rounded-2xl border border-[hsl(var(--border))] bg-white overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3 min-w-0">
          <div className="h-9 w-9 rounded-xl flex items-center justify-center shrink-0" style={{ background: "linear-gradient(135deg, #0866FF, #0866FF)" }}>
        ...
        <div className="flex items-center gap-3 shrink-0 ml-3">
          <svg className="h-9 w-9 -rotate-90" viewBox="0 0 36 36">
            ...
            <circle cx="18" cy="18" r="14" fill="none" stroke="#0866FF" strokeWidth="4"
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-3 md:space-y-5">
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.05 }}
        ...
        {[
          { label: "Total Jamaah", value: totalJamaah, icon: Users, color: "#0866FF" },
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.1 }}
          ...
          <div className="w-full h-2 md:h-3 bg-gray-100 rounded-full overflow-hidden">
            <motion.div
              ...
              style={{ background: "linear-gradient(90deg, #0866FF, #6694ff, #fbbf24)" }}
            />
          </div>
