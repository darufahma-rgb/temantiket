        ...
        {loading ? (
          ...
          <>
            ...
            <div className="mt-16 -mx-4 px-4 py-12 rounded-3xl" style={{ background: "linear-gradient(135deg, #eef2ff 0%, #e8edf8 50%, #eff6ff 100%)" }}>
              ...
              {waNumber && (
                <div className="mt-8 relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#0654D6] via-[#0866FF] to-[#0866FF] p-8 text-center text-white shadow-xl">
                  ...
                  <div className="relative">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-2 bg-white text-[#0654D6] font-black text-sm px-7 py-3 rounded-xl hover:bg-blue-50 transition-colors shadow-lg"
                    >
