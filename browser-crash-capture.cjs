...
async function main() {
  if (!EMAIL || !PASSWORD) {
    console.log('Usage: SITE="https://temantiket.vercel.app" EMAIL="..." PASSWORD="..." AGENT_ID="..." node browser-crash-capture.cjs');
    process.exit(1);
  }
  ...
  for (const path of paths) {
    ...
    console.log("Body preview:", bodyText.slice(0, 900).replace(/\n/g, " | "));
  ...
  console.log("\n==============================");
  console.log("API/SUPABASE RESPONSES");
  console.log("==============================");
  responses.slice(-80).forEach((r) => console.log(r));

  console.log("\n==============================");
  console.log("RECENT CONSOLE LOGS");
  console.log("==============================");
  logs.slice(-120).forEach((l) => console.log(l));
